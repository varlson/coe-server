...
slideRouter.get("/", (req, res) => {
    try {
        post_1.default.find({ postType: types_1.PostTypes.NEWS })
            .then((notices) => {
            if (notices.length)
...
// CRIAR EDITAIS
slideRouter.post("/create-notice", upload.single("file"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// DELETAR UM EDITAL
slideRouter.get("/delete/:id", (req, res) => {
    const { id } = req.params;
    if (!id)
        return res.status(404).json({
            success: false,
...
// EDITAR UM EDITAL
slideRouter.post("/update/:id", upload.single("file"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    if (!id)
        return res.status(404).json({
            success: false,
    ...
    const notice = { title, edit_by, body };
    if (file) {
